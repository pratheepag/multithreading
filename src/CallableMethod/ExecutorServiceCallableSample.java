...
public class ExecutorServiceCallableSample {
    ...
    public static void main(String args[]) throws InterruptedException, ExecutionException, TimeoutException {
        ...
        submitMultipleCallablesWithExecutor();
    }
     ...
     * @throws ExecutionException 
     */
    public static void submitMultipleCallablesWithExecutor() throws InterruptedException, ExecutionException, TimeoutException{
     ...
     */
    private static Double someExpensiveRemoteCall(){
     ...
     */
    private static Callable<Double> createCallable(){
